...
"num_patch" : 1000, # Number of patches for each case
...
"model_name" : 'unet_2015_2', # model name [M,S]

"prediction_dataset" : 'train', # prediction dataset for predict.py
"test_data_dir" : '/data/mri/isles/data_2015/SISS2015_Training', # '/data/mri/isles/data_2015/ISLES2015_SISS_Testing', # input directory for predict.py
